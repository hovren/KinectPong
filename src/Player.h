...
public:
	...
	void get_paddle_gradients(std::vector<cv::Point2f>& contour, std::vector<cv::Point2f>& gradient);
...
private:
	...
	std::vector<cv::Point2f> m_paddle_contour;
	std::vector<cv::Point2f> m_paddle_gradient;
